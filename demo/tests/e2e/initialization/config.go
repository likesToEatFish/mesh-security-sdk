...
import (
	...
	"github.com/osmosis-labs/mesh-security-sdk/demo/tests/e2e/util"
	// treasurytypes "github.com/osmosis-labs/mesh-security-sdk/x/treasury/types"
)
...
const (
	...
	// chainA
	ChainAID      = "mesh-test-a"
	MeshBalanceA  = 20000000000000
	StakeBalanceA = 110000000000
	StakeAmountA  = 100000000000
	// chainB
	ChainBID          = "mesh-test-b"
	MeshBalanceB      = 500000000000
	StakeBalanceB     = 440000000000
	StakeAmountB      = 400000000000
	GenesisFeeBalance = 100000000000
	WalletFeeBalance  = 100000000
	// // chainC
	// ChainCID      = "mesh-test-c"
	// MeshBalanceC = 500000000000
...
var (
	...
	StakeAmountCoinA = sdk.NewCoin(MeshDenom, StakeAmountIntA)
	StakeAmountIntB  = sdk.NewInt(StakeAmountB)
	StakeAmountCoinB = sdk.NewCoin(MeshDenom, StakeAmountIntB)

	InitBalanceStrA = fmt.Sprintf("%d%s", MeshBalanceA, MeshDenom)
	InitBalanceStrB = fmt.Sprintf("%d%s", MeshBalanceB, MeshDenom)
	// InitBalanceStrC = fmt.Sprintf("%d%s", MeshBalanceC, Meshdenom)
	meshToken = sdk.NewInt64Coin(MeshDenom, IbcSendAmount) // 3,300mesh
	tenMesh   = sdk.Coins{sdk.NewInt64Coin(MeshDenom, 10_000_000)}
...
func updateMintGenesis(mintGenState *minttypes.GenesisState) {
	mintGenState.Params.MintDenom = MeshDenom
}

func updateBankGenesis(bankGenState *banktypes.GenesisState) {
	denomsToRegister := []string{MeshDenom, AtomDenom}
...
func updateCrisisGenesis(crisisGenState *crisistypes.GenesisState) {
	crisisGenState.ConstantFee.Denom = MeshDenom
}
...
// 		Cap:     sdk.NewCoin(meshdenom, sdk.NewInt(100000000000000)),
// 	}
// }
...
func updateGovGenesis(govGenState *govv1.GenesisState) {
	...
	govGenState.Params.MinDeposit = tenMesh
}
