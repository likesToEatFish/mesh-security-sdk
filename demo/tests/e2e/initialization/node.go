...
import (
	...
	meshApp "github.com/osmosis-labs/mesh-security-sdk/demo/app"
...
func (n *internalNode) createAppConfig(nodeConfig *NodeConfig) {
	...
	appConfig.MinGasPrices = fmt.Sprintf("%s%s", MinGasPrice, MeshDenom)
...
func (n *internalNode) init() error {
	...
	appState, err := json.MarshalIndent(meshApp.ModuleBasics.DefaultGenesis(util.Cdc), "", " ")
	if err != nil {
