...
func (s *IntegrationTestSuite) SetupSuite() {
	...
	if str := os.Getenv("MESH_E2E_SKIP_STATE_SYNC"); len(str) > 0 {
	...
	if str := os.Getenv("MESH_E2E_DEBUG_LOG"); len(str) > 0 {
